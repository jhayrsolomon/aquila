$(document).ready(function(){
    ...
    var youtube_keys = [
        ...
        "AIzaSyBLGqKmHFOiS_H99D_U5ktr8KdWLX1bbcU",
    ...
    var google_keys = [
        ...
        "AIzaSyCzSshPK3lApv9whP1894DD2bpmRtlxXBI",
        "AIzaSyCLpMaZPmSPd84xW-iJjOirxJRDTGhCaRM",
    ...
    function deploy_stored_data(){
        ...
        $.ajax({
            ...
            console.log("deploy_stored_data");
            console.log(data);
    ...
    function student_view_actual(){

        $(".close_student_view").click(function(){
            window.location.replace(url+"index");
        });

        $(".edit_area").removeClass("close_edit");
        $(".student_view").removeClass("student_view_close");
        ...
        console.log(active_content_data);
        if(!active_content_data){
            console.log("no active_content_data");
            deploy_stored_data();
        }else{
            adjust_iframe();
            populate_slides();
    ...
    $("#send_emails_now").click(function(){
        new_send_email_notification();
    });

    function new_send_email_notification(){
