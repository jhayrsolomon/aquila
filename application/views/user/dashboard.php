                                        ...
                                        <tbody>
                                            <?php if ($sch_setting->admission_date) { ?>
                                                <tr>
                                                    ...
                                                    <td class="col-md-5"> <?php if (!empty($student['admission_date'])) { echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($student['admission_date'])); } ?> </td>
                                                </tr>
                                            <?php } ?>
                                            <tr>
                                        ...
                                        <?php }
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($student_due_fee as $key => $fee) {
                                                    foreach ($fee->fees as $fee_key => $fee_value) {
                                                        ...
                                                        <?php } ?>
                                                            ...
                                                            <td></td>
                                                            <td></td>
                                                            <td class="text text-right"><?php echo (number_format($fee_discount, 2, '.', '')); ?></td>
                                                ...
                                                if (!empty($student_discount_fee)) {
                                                    foreach ($student_discount_fee as $discount_key => $discount_value) { ?>
                                                        <tr class="dark-light">
                                                            ...
                                                            <td class="text text-left"></td>
                                                            <td class="text text-left"></td>
                                                            <td class="text text-right"> <?php $alot_fee_discount = $alot_fee_discount; ?></td>
                                                            <td></td>
                                                            <td></td>
                                                            <td></td>
                                                        </tr>
                                                ...
                                                <tr class="box box-solid total-bg">
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td class="text text-right"><?php echo ($currency_symbol . number_format($total_discount_amount + $alot_fee_discount, 2, '.', '')); ?></td>
                                                    <td class="text text-right"><?php echo ($currency_symbol . number_format($total_fine_amount, 2, '.', '')); ?></td>
                                                    <td class="text text-right"><?php echo ($currency_symbol . number_format($total_deposite_amount, 2, '.', ''));?></td>
                                                    <td class="text text-right"><?php echo ($currency_symbol . number_format($total_balance_amount - $alot_fee_discount, 2, '.', ''));?></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
                                            ...
                                            <?php foreach ($timeline_list as $key => $value) { ?>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="timeline-item">
                                                        ...
                                                        <div class="timeline-body"> <?php echo $value['description']; ?></div>
                                                    </div>
                                                </li>
                                            <?php } ?>
                                                                ...
                                                                foreach ($exam_value->exam_result['result'] as $exam_result_key => $exam_result_value) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <?php if ($exam_value->exam_type != "gpa") { ?>
                                                                            ...
                                                                            <td>
                                                                                <?php  echo $exam_result_value->get_marks;
